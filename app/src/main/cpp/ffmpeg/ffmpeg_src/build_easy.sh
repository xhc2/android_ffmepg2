...
NDK_PATH=/Users/mrx/mrx_save/android_ndk/android-ndk-r17c
...
build_bin() {
    ...
    ./configure \
         ...
         --extra-cflags="-I$NDK_PATH/sysroot/usr/include/$4 -isysroot $NDK_PATH/sysroot $CFALGS -I$OPENSSL -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated" \
         --extra-cxxflags="-D__thumb__ -fexceptions -frtti" \
         --extra-ldflags="-L${SYSROOT}/usr/lib -L$OPENSSL/lib" \
         --enable-shared \
         --disable-asm \
         --enable-neon \
         --disable-encoders \
